...
const NewBlog = ({ open, setOpen }: Props) => {
  ...
  const handleGenerate = async () => {
    ...
    const response = await sendPromptToGemini({
      prompt: `
        Escreva um blog sobre qualquer tema de sua escolha. Crie sempre algo diferente e não repita, na lingua ${locale}
        Siga esse exmplo e respeite as regras abaixo:
        {
          "title": "Título do blog (max. 60 caracteres)",
          "subtitle": "Subtítulo do blog (max. 191 caracteres)",
